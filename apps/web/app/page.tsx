...
export default async function Dashboard({ searchParams }: { searchParams: Promise<Search> }) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-muted text-[11px]">as of {inflections.as_of.slice(0, 10)} · dataset {inflections.dataset} · window {since} · <span className="kbd">j</span>/<span className="kbd">k</span> move, <span className="kbd">Enter</span> open</div>
